...
public class ChatService(IChatCompletionService chatCompletionService, TokenizerService tokenizerService, HybridCache cache, IOptions<AppSettings> appSettingsOptions, ILogger<ChatService> logger)
{
    ...
    public async Task<ChatResponse> AskQuestionAsync(Guid conversationId, IEnumerable<DataAccessLayer.Entities.DocumentChunk> chunks, string question, CancellationToken cancellationToken = default)
    {
    ...
    public async IAsyncEnumerable<ChatResponse> AskStreamingAsync(Guid conversationId, IEnumerable<DataAccessLayer.Entities.DocumentChunk> chunks, string question, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        var chat = CreateChatAsync(chunks, question);
    ...
    private ChatHistory CreateChatAsync(IEnumerable<DataAccessLayer.Entities.DocumentChunk> chunks, string question)
    {
